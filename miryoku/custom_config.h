...
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),  U_LT(U_NAV, BSPC), U_LT(U_MOUSE, DEL),  U_LT(U_SYM, RET),   U_LT(U_NUM, SPACE),  U_LT(U_FUN, TAB),  U_NP,              U_NP
...
U_NP,              U_NP,              &kp ESC,           &kp BSPC,          &kp DEL,           &kp RET,           &kp SPACE,         &kp TAB,           U_NP,              U_NP
...
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp RET,           &kp SPACE,         &kp TAB,           U_NP,              U_NP
...
&kp COLON,         &kp DLLR,          &kp PRCNT,         &kp CARET,         &kp PLUS,          U_NA,              &kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         \
